 ...
 */
@Autonomous(name="Blue Park Building Wall Close")
public class BlueParkBuildingWallCloseAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        ParkCloseRoutine.run(this, "blue", "building", "wall");
